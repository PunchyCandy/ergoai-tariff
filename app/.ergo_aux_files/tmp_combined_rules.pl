...
?-(fllibinsrulesig(30,'tmp_combined_rules.ergo','_$_$_ergo''descr_vars',FLORA_THIS_MODULE_NAME,40,FLORA_THIS_WORKSPACE(d^tblflapply)(applicable_rate,__S,0.0,flapply(expl,exempt,flapply(detail,flapply(items,[flapply(rule,__R),flapply(source,__Src)]))),'_$ctxt'(_CallerModuleVar,30,__newcontextvar1)),','(flibnafdelay(flora_naf(FLORA_THIS_WORKSPACE(tabled_naf_call)(','(FLORA_THIS_WORKSPACE(d^tblflapply)(de_minimis_applies_s,__S,'_$ctxt'(FLORA_THIS_MODULE_NAME,__newcontextvar2,30)),fllibexecute_delayed_calls([__S],[]))),[__S],104,'tmp_combined_rules.ergo')),FLORA_THIS_WORKSPACE(d^tblflapply)(exempt_applies,__S,__R,__Src,'_$ctxt'(FLORA_THIS_MODULE_NAME,__newcontextvar3,30))),null,'_$_$_ergo''rule_enabled'(30,'tmp_combined_rules.ergo',FLORA_THIS_MODULE_NAME),null,true)).
...
?-(fllibinsrulesig(34,'tmp_combined_rules.ergo','_$_$_ergo''descr_vars',FLORA_THIS_MODULE_NAME,42,FLORA_THIS_WORKSPACE(d^tblflapply)(duty,__S,__DutyUSD,__Rate,__Expl,'_$ctxt'(_CallerModuleVar,34,__newcontextvar1)),','(FLORA_THIS_WORKSPACE(d^tblflapply)(shipment,__S,___O,___I,___P,__V,___D,'_$ctxt'(FLORA_THIS_MODULE_NAME,__newcontextvar2,34)),','(FLORA_THIS_WORKSPACE(d^tblflapply)(applicable_rate,__S,__Rate,__Expl,'_$ctxt'(FLORA_THIS_MODULE_NAME,__newcontextvar3,34)),fllibdelayedliteral('\\is','tmp_combined_rules.ergo',121,[__DutyUSD,*(__V,__Rate)]))),null,'_$_$_ergo''rule_enabled'(34,'tmp_combined_rules.ergo',FLORA_THIS_MODULE_NAME),fllibexecute_delayed_calls([__DutyUSD,__Expl,__Rate,__S,__V,___D,___I,___O,___P],[__DutyUSD,__Expl,__Rate,__S]),true)).
